...
import { 
    PlayerMovementIdleState,
    PlayerMovementMovingLeftState,
    PlayerMovementMovingRightState 
} from "./PlayerMovementStates";
import {
    PlayerJumpingIdleState,
    PlayerJumpingActiveState
} from "./PlayerJumpingStates";
...
export class PlayerOther extends Player {
     ...
     * @param color
     */
    constructor(scene: Scene, sid: any, pos_x: integer, pos_y: integer, color: string) {
